...
class DaemonRunner(object):
    ...
    start_message = "Daemon started (pid %(pid)d)."
    ...
    def _start(self):
        ...
        emit_message(message, stream=self.daemon_context.stdout)
    ...
    def _terminate_daemon_process(self):
        ...
        try:
            ...
            emit_message("OMG! Ponies! Bye-bye!", stream=self.daemon_context.stdout)
